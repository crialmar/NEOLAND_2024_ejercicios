...
const MenssageSchema = new Schema(
  {
    ...
    recipientActor: { //*------> vamos a hacer tres claves distintas que NO estarán requeridas xq son las tres posibilidades de receptor
      type: mongoose.Schema.Types.ObjectId,
      ref: "Actores",
    },
    recipientMusical: { type: mongoose.Schema.Types.ObjectId, ref: "Musical" },
